...
const LandingPage = ({ onGetStarted }) => {
  return (
    <div className="min-h-screen bg-background overflow-hidden relative selection:bg-primary/30">
      ...
      {/* Navbar */}
      <nav className="relative z-10 flex items-center justify-between px-4 md:px-8 py-6 max-w-7xl mx-auto">
      ...
      {/* Hero Section */}
      <main className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 pt-12 md:pt-20 pb-24 md:pb-32">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tight mb-8 leading-[1.1] animate-slide-in">
      ...
      <div className="relative max-w-6xl mx-auto px-4 md:px-8 animate-fade-in [animation-delay:800ms]">
